...
# %%
xy_system_1 = XYSystem(temperature  = 0.5, width = 20)
...
# %%
xy_system_2 = XYSystem(width=100)
cool_dat=xy_system_2.annealing(T_init=0.001,T_final=1.5,nsteps = 10,show_equi=True)

# %%
xy_system_2 = XYSystem(width=50)
cool_dat=xy_system_2.annealing(T_init=0.001,T_final=1.5,nsteps = 10,show_equi=True)

# %%
xy_system_2 = XYSystem(width=20)
cool_dat=xy_system_2.annealing(T_init=0.001,T_final=1.5,nsteps = 10,show_equi=True)

# %%
xy_system_2 = XYSystem(width=20)
cool_dat=xy_system_2.annealing(T_init=0.001,T_final=0.6,nsteps = 10,show_equi=True)
